...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_SYM] = LAYOUT(
        ...
        KC_TRNS , KC_NO  , KC_NO  , KC_LCBR , KC_RCBR, KC_PLUS,                            KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  ,
        KC_NO   , KC_NO  , KC_NO  , KC_LBRC , KC_RBRC, KC_UNDS,                            KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  ,
        KC_TRNS , KC_TRNS, KC_LABK, KC_RABK , KC_QUES, KC_COLN,                            KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  ,
                                             KC_NO   , KC_TRNS, KC_SPC,          KC_NO  , L_BASE , QK_LLCK
    ),
    [_GAMING] = LAYOUT(
        KC_GRV  , KC_1   , KC_2   , KC_3   , KC_4   , KC_5   ,                            KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , KC_BSPC,
